...
class RegisterCountForm(Form):
    ...
    def __init__(self, is_open, register=None, *args, **kwargs):
            ...
            if is_open:
                self.fields['reg_%s_active' % register.name] = forms.BooleanField(label="active", initial=True, required=False)
...
class OpenForm(Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for register in registers:
            self.fields['brief_%s' % register.name] = forms.BooleanField(label=register.name, initial=False,
                                                                         required=False)
