...
from externalise.models import ExternaliseDocument, IncorrectPriceError, IncorrectCountError, ExternaliseLine
...
class ExternaliseTests(TestCase, TestData):
    ...
    def test_single_article(self):
        ...
        els = ExternaliseLine.objects.all()
        self.assertEqual(len(els), 1)
        el = els[0]
        self.assertEqual(el.count, count)
        self.assertEqual(el.article_type, self.articletype_1)
        self.assertEqual(el.cost, local_cost)
