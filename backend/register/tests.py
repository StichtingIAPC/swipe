...
class BasicTest(TestCase, TestData):
    ...
    def test_get_closed_register_counts(self):
        ...
        self.reg3.save()
        self.reg4.save()
        counts_begin = RegisterMaster.get_closed_register_register_counts()
        self.assertEqual(len(counts_begin), 4)
        self.reg2.open(Decimal(0))
        counts = RegisterMaster.get_closed_register_register_counts()
    ...
    def test_get_only_last_closing_count(self):
        ...
        self.reg2.save()
        counts_begin = RegisterMaster.get_closed_register_register_counts()
        self.assertEqual(len(counts_begin), 1)
        self.reg2.open(Decimal(0))
        counts = RegisterMaster.get_closed_register_register_counts()
