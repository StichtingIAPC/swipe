...
export function createAccountingGroup(accountingGroup) {
	return { type: 'ACCOUNTING_GROUP_CREATE', accGrp: accountingGroup };
}

export function updateAccountingGroup(accountingGroup) {
	return {	type: 'ACCOUNTING_GROUP_UPDATE', accGrp: accountingGroup };
}

export function deleteAccountingGroup(accountingGroup) {
	return { type: 'ACCOUNTING_GROUP_DELETE', accGrp: accountingGroup };
}

export function accountingGroupInputError(error) {
	return { type: 'ACCOUNTING_GROUP_INPUT_ERROR', error: error }
}

export function accountingGroupFetchError(error) {
	return { type: 'ACCOUNTING_GROUP_FETCH_ERROR', error: error }
}
