...
export const startFetchingStockList = ({ redirectTo } = {}) => ({ type: STOCK_FETCH_START,
	redirectTo });

export const doneFetchingStockList = stock => ({ type: STOCK_FETCH_DONE,
	stock });
export const fetchingStockListError = error => ({ type: STOCK_FETCH_FAILED,
	error });
