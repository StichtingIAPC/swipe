...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        Register.objects.create(name="Cash", currency=eur, is_cash_register=False, is_active=True, payment_type=maestro)
        Register.objects.create(name="Cash", currency=eur, is_cash_register=False, is_active=True, payment_type=invoice)
        Register.objects.create(name="Cash", currency=eur, is_cash_register=False, is_active=False, payment_type=bitcoin)
