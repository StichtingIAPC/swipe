...
class PackingDocumentLine(models.Model):
    ...
    def save(self):
        ...
        if self.line_cost is not None:
            ...
            # No invoice if
            assert not hasattr(self, 'invoice') or self.invoice is None
    ...
    def __str__(self):
        ...
        return "Packing Document: {}, SupplierOrderLine: {}, ArticleType: {}, Cost: {}, Invoice: {}".format(
            self.packing_document.pk, self.supplier_order_line.pk, self.article_type, cost, invoice
        )
