...
class StockTest(TestCase):
    ...
    def testAddToStock(self):
        ...
        StockLog.objects.create(description="henk", entries=[ES])
        StockLog.objects.create(description="henk", entries=[ES])
    ...
    def testAddMultipleToStock(self):
        ...
        sl = StockLog.objects.create(description="henk", entries=[ES, ES2])
        stocks = Stock.objects.all()
        for stock in stocks:
    ...
    def testTwoArticleMerges(self):
        ...
        s = StockLog.objects.create(description="henk", entries=[ES, ES2])

        StockLog.objects.create(description="henk", entries= [ES, ES2])
        StockLog.objects.create(description="henk", entries= [ES, ES2, ES])
        ES2 = StockModification(article=art2, book_value=sp2, count=1, is_in=False)
        StockLog.objects.create(description="henk", entries= [ES2])
    ...
    def testOneTwoThreeFourFiveSix(self):
        ...
        for i in range(1, 7):  # 1 to 6. Average: should be 3.5
            ...
            StockLog.objects.create(description="LOG" + str(i), entries=[es])
    ...
    def testDifferentCurrencies(self):
        ...
        StockLog.objects.create(description="LOG", entries=[es])
